...
1. [Arquitectura del sistema](#1-arquitectura-del-sistema)
   - [Arquitectura del Backend](#11-arquitectura-del-backend)
   - [Arquitectura del Frontend](#12-arquitectura-del-frontend)
2. [Diseño de base de datos y modelo entidad-relación](#2-diseño-de-base-de-datos-y-modelo-entidad-relación)
3. [Estructura de carpetas](#3-estructura-de-carpetas)
4. [Tecnologías y librerías](#4-tecnologías-y-librerías)
5. [Endpoints desarrollados](#5-endpoints-desarrollados)
6. [Modelo de autenticación JWT y roles](#6-modelo-de-autenticación-jwt-y-roles)
7. [Reglas de negocio y validación de reservas](#7-reglas-de-negocio-y-validación-de-reservas)
...
## 6. Modelo de autenticación JWT y roles
...
## 7. Reglas de negocio y validación de reservas
